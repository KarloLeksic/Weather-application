...
const API_URL = `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=${currentUnits}&appid=${API_KEY}`;
...
function drawCurrentConditions(data) {
  ...
  // Set rain and maybe snow if it's available
  /* todo */
  const rainProbabilityEl = document.querySelector('.rain-probability p');
}
